"""Custom LangChain LLM wrapper for HuggingFace Inference Client."""
...
class HuggingFaceChatModel(BaseChatModel):
    """Custom chat model using HuggingFace Inference Client."""
    
    client: Any = Field(default=None, exclude=True)
    model: str = Field(default="moonshotai/Kimi-K2-Thinking")
    ...
    def _convert_messages_to_hf_format(self, messages: List[BaseMessage]) -> List[Dict[str, str]]:
        ...
        for message in messages:
            if isinstance(message, HumanMessage):
                ...
                hf_messages.append({"role": "user", "content": str(message.content)})
        return hf_messages
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            error_message = f"Error calling HuggingFace API: {str(e)}"
